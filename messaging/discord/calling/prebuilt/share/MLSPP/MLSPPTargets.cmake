...
foreach(_cmake_expected_target IN ITEMS MLSPP::bytes MLSPP::hpke MLSPP::tls_syntax MLSPP::mls_ds MLSPP::mls_vectors MLSPP::third_party MLSPP::mlspp)
...
set_target_properties(MLSPP::bytes PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/mlspp"
...
set_target_properties(MLSPP::hpke PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/mlspp"
  INTERFACE_LINK_LIBRARIES "MLSPP::bytes;MLSPP::tls_syntax;\$<LINK_ONLY:OpenSSL::Crypto>"
)
...
# Create imported target MLSPP::mls_ds
add_library(MLSPP::mls_ds STATIC IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/MLSPPTargets-*.cmake")
