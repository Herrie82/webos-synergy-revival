...
enyo.kind({
	...
	components: [
		...
		// Flush-right unread badge (like the server/channel rows): the flex:1 summary column pushes it
		// to the right edge, vertically centred across the row.
		{name: "unreadCount", className: "unread-count thread-unread", showing: false}
	],
	create: function() {
