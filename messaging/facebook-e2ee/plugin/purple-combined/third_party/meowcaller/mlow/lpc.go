...
// The DCT cosine tables are constants (they depend only on nfft/order), but the analysis rebuilt them
// via genCosRow on every frame — ~16 rows of cos, profiled ~5% of the encode. Build once, reuse.
var (
