 ...
 * Called by com.palm.app.gdrive-auth at the start of account creation.
 */
function GetAuthorizeUrlCommandAssistant() {}

GetAuthorizeUrlCommandAssistant.prototype = {
	allowedAppIds: ["com.palm.app.gdrive-auth"],
	...
	run: function (future) {
		...
		try {
			...
			var url = OAuth2.buildAuthorizeUrl(args.state || "gdrive");
			future.result = {
				returnValue: true,
				url: url,
