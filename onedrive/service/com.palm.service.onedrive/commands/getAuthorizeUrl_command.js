 ...
 * Called by com.palm.app.onedrive-auth at the start of account creation.
 */
function GetAuthorizeUrlCommandAssistant() {}

GetAuthorizeUrlCommandAssistant.prototype = {
	allowedAppIds: ["com.palm.app.onedrive-auth"],
	...
	run: function (future) {
		...
		try {
			...
			var url = OAuth2.buildAuthorizeUrl(args.state || "onedrive");
			future.result = {
				returnValue: true,
				url: url,
